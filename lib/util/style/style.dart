...
class Style {
  ...
  static final Color bTextColor = Colors.blue[800];

  /// 主要背景色
  static const Color pBackgroundColor = Color(0xFFEDEDED);

  static final Color sBackgroundColor = Colors.grey.withOpacity(0.2);

  /// 警告色
  static const Color pTextWarnColor = Color(0xFFFA5151);

  /// 头像背景色
  static final Color pAvatarBgColor = Colors.grey.withOpacity(0.3);
}
